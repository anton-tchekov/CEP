...
HD_PWD='D:/Vivado/aufgabe1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log increment_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source increment_tb.tcl
